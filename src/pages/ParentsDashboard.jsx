...
export default function ParentsDashboard() {
  ...
  const steps = [
    ...
    },
    {
      ...
      num: "3",
      title: "Acompanhe os graficos",
      desc: "Assim que os dados chegarem, os graficos aparecem aqui automaticamente.",
    },
  ];
          ...
          <div className={`w-full max-w-lg rounded-3xl border p-8 shadow-2xl ${t.modalBg}`}>
            <div className="flex items-center justify-between mb-6">
              ...
              <button
                ...
                className={`rounded-full p-2 transition ${t.btnGhost}`}
              >
                <X size={18} />
              </button>
            </div>
            ...
            <p className={`mt-6 text-xs text-center ${t.textMuted}`}>
            ...
            <button
              type="button"
              onClick={() => setShowInstructions(false)}
              className={`mt-4 w-full rounded-xl px-5 py-3 font-semibold transition ${t.btnPrimary}`}
            >
              Entendi, vou começar!
            </button>
          </div>
      ...
      <div className={`mx-auto w-full max-w-5xl rounded-3xl border p-4 shadow-2xl backdrop-blur md:p-6 ${t.shell}`}>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className={`inline-flex items-center gap-2 rounded-xl border px-4 py-2 text-sm font-semibold transition ${t.btnGhost}`}
              >
                <HelpCircle size={16} />
                Como usar?
              </button>
        ...
        <section className={`mt-4 rounded-2xl border p-5 ${t.panel}`}>
          ...
          <p className={`mt-1 text-sm ${t.textMuted}`}>
            Selecione o filho para ver os dados de uso dele.
          </p>
          <div className="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-2">
            <div>
              <label className={`mb-1 block text-xs font-semibold uppercase tracking-wide ${t.textMuted}`}>
                Filho
              </label>
              <select
                ...
                className={`w-full rounded-xl border px-3 py-2 text-sm outline-none ${t.input}`}
              >
                {filhos.length === 0 ? (
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  onChange={(e) => setNomeEdicaoFilho(e.target.value)}
                ...
                <button
                  ...
                  className={`rounded-xl px-3 py-2 text-sm font-semibold transition disabled:opacity-50 ${t.btnPrimary}`}
                >
                  Salvar
                </button>
              </div>
        ...
        <section className={`mt-4 rounded-2xl border p-5 ${t.panel}`}>
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            <button
              ...
              className={`inline-flex items-center gap-2 rounded-xl px-4 py-2 text-sm font-semibold transition disabled:opacity-60 ${t.btnPrimary}`}
            >
            ...
            <button
              ...
              disabled={!token}
              className={`inline-flex items-center gap-2 rounded-xl border px-4 py-2 text-sm font-semibold transition disabled:opacity-50 ${t.btnGhost}`}
            >
        ...
        {canRenderCharts ? (
          ...
          <section className={`mt-4 rounded-2xl border p-8 text-center ${t.panel}`}>
            ...
            <button
              type="button"
              onClick={() => setShowInstructions(true)}
              className={`mt-4 inline-flex items-center gap-2 rounded-xl border px-5 py-2 text-sm font-semibold transition ${t.btnGhost}`}
            >
              <HelpCircle size={15} />
              Ver instrucoes
            </button>
            {message && (
              <p className={`mt-3 text-sm ${t.textMuted}`}>{message}</p>
            )}
          </section>
        )}
      </div>
